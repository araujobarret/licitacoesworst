...
app.get('/create_test/:codigo_item_material', (req, res) => {
  ...
  //         if(valor != null)
  //           if(valor < 2.6)
  //             temp.processador_normalizado = 'comum';
  //           else
  //             if(valor <= 3.2)
  //               temp.processador_normalizado = 'alto';
  //             else
  //               temp.processador_normalizado = 'altissimo';
  //         else
  ...
  //             }
  //             else
  //               if(temp.processador_valido.search('i7') != -1 || temp.processador_valido.search('6 nucleos') != -1 ||
  //                temp.processador_valido.search('xeon') != -1){
  //                 temp.processador_normalizado = 'altissimo';
  ...
  //
  // let arffArray = {
  //   name: 'padronizado-weka-filters.supervised.attribute.Discretize-Rfirst-last-precison-CARLOS',
  //   attributes: [
  //     'Processador',
  //     'Memoria',
  //     'Video',
  ...
  //   types: {
  //     Processador: {
  //       type: 'Normalizado\' {comum, alto,altissimo}'
  //     },
  //     Memoria: {
  //       type: '\' {\'\\\'(-inf-0.5]\\\'\',\'\\\'(0.5-1.5]\\\'\',\'\\\'(1.5-5]\\\'\',\'\\\'(5-12]\\\'\',\'\\\'(12-inf)\\\'\'}'
  //     },
  //     Video: {
  //       type: 'nominal',
  //       oneof: [
